...
class Player { //packman
    constructor ({
        ...
        this. radius = (3 * canvas.height) / 184 //увеличили радиус самого пакмана (до этого был 10) !! ПОДУМАТЬ КАК СДЕЛАТЬ АДАПТИВНОСТЬ
        this.radians = 0.75
        this.openRate = 0.12
        this.rotation = 0 
    }
...
class Ghost { 
    ...
    constructor ({
        ...
        this. radius = (3 * canvas.height) / 184
        this.color = color
        this.prevCollisions = []
        this.speed = 2
        this.scared = false 
...
function animate() {
    ...
    if (keys.w.pressed && lastKey === 'w') {
        ...
        for (let i = 0; i < boundaries.length; i++) { //i -- итератор; добавляем 1 к i, пока она не станет больше длинны границ
            ...
            player.velocity.x = -2 //идём влево, когда нажимаем клавишу а
        }
        }
